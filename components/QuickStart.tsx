...
export default function QuickStart({ userId }: { userId: string }) {
  ...
  return <>
    <button onClick={() => { setStep(0); setOpen(true); }} className="ml-auto rounded-lg border border-slate-700 px-4 py-3 text-sm font-medium text-slate-200 hover:border-brand-400 hover:text-brand-300">Quick start</button>
