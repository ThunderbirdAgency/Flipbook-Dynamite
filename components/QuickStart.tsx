...
const lessons = [
  ...
  { title: "Choose who can read it", label: "Privacy", body: "Before sharing, open Share → Privacy and confirm the access setting. New uploads are shared by link by default.", tips: ["Shared by link: anyone with the address can read the book.", "Private without a password: only the owner can read it. With a password: readers need that password.", "Hiding the download button is a reader preference, not copy protection. Share sensitive documents only with the intended readers."] },
